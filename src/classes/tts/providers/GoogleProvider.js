...
class GoogleProvider extends AbstractProvider {
  ...
  getPlayLogMessage(payload, guild) {
    ...
    return `(TTS): Playing googleTTS for ${sentence} with language ${lang} at ${speed} in the server ${guild.name}.`;
  }
  ...
  setLang(newLang) {
    ...
    if (this.lang === newLang) {
      throw new GoogleProviderError(`The language has been set to ${newLang}!`, GoogleProviderError.REASON.same);
    }
